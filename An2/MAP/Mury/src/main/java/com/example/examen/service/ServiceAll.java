...
//        return repoControllerUF.findUser(id);
    ...
    public Iterable<Hotel> findAllHotels() {
        return RepoController.getInstance().findAllHotels();
    }
public Hotel findHotel(Double id) {
        return RepoController.getInstance().findHotel(id);
    }
    public Iterable<Location> findAllLocations() {
        return RepoController.getInstance().findAllLocations();
    }
    public Location findLocation(Double id) {
        return RepoController.getInstance().findLocation(id);
    }

    public Iterable<SpecialOffer> findAllSpecialOffers() {
        return RepoController.getInstance().getAllSpecialOffers();
    }
